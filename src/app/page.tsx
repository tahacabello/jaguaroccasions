            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  maxLength={6}
                  placeholder="••••"
                  className="w-full bg-zinc-950/80 border border-zinc-800 focus:border-amber-500 focus:outline-none rounded-xl py-3 px-4 text-center text-lg tracking-[8px] text-white font-bold transition-all"
                  autoFocus
                />
